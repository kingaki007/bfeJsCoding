...
function virtualize(element) {
    ...
    for (let attr of element.attributes) {
        ...
        result.props[propName] = attr.value;
    }
...
const virtualise = virtualize(el);
console.log(virtualise);

document.getElementById("def").innerHTML = JSON.stringify(virtualise);
const rendered = render(virtualise);
document.getElementById("ghi").append(rendered);
